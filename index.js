...
client.on("messageCreate", async (message) => {
  ...
  outstandingVerifications = outstandingVerifications.filter(
    (verificationRequest) => verificationRequest.userId !== message.author.id
  );
  ...
  await message.author.send(
    "Please follow this link and verify your Account by signing a message: " +
      verificationRequest.url
  );
  await message.reply(
    "Please check your DMs, you received instructions to verify your account!"
  );
});
