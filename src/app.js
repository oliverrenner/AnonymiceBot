...
app.get("/api/stats/i3AJx0P7Ln/address", async (req, res) => {
  statsApiController.getUserOfAddress(req, res);
});

app.get("/api/stats/3NaiP3hNM/userid", async (req, res) => {
  statsApiController.getUserOfUserId(req, res);
});
