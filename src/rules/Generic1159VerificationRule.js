/*##############################################################################
# File: Generic1159VerificationRule.js                                             #
...
Argument(s):    ${user.walletAddress} ${this.config.tokenId}`;
    try {
      ...
      let contractResult = await contract[this.config.method](user.walletAddress, this.config.tokenId);
